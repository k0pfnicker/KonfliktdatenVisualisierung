...
export const animationRow         = document.getElementById("animationRow");
...
export const arResetContainer     = document.getElementById("arResetContainer");
...
export const metricEventsBtn      = document.getElementById("metricEventsBtn");
export const metricFatalitiesBtn  = document.getElementById("metricFatalitiesBtn");
export const metricToggleRow      = metricEventsBtn?.closest(".toggle-row") ?? null;
...
export const legend2DMin          = document.getElementById("legend2DMin");
export const legend2DMax          = document.getElementById("legend2DMax");
